...
// Location: apps/backend/src/config/seed.js
//
...
const { PrismaClient, HackathonStatus, JudgingPhase, TeamMemberRole, UserRole, InvitationStatus, SubmissionStatus } = require('@prisma/client');
...
async function main() {
  ...
  async function createCompleteTeam(hackathonId, name, description, neededSkills, isOpen, members, submissionData) {
